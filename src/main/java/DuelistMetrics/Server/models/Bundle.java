...
public class Bundle {
    ...
    @ElementCollection
    private List<String> iterms_purged;
    ...
    public void setIterms_purged(List<String> iterms_purged) {
        this.iterms_purged = iterms_purged;
    }
    ...
    public List<String> getIterms_purged() {
        return iterms_purged;
    }
