...
public abstract class GeneralScoringCard {
    ...
    public abstract String getCard_id();
    public abstract String getPool_name();
    public abstract GeneralScoringCard generate(String card_id, String pool_name);
